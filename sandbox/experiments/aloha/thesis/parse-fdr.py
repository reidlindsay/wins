...
"""
Parse FDR data for ALOHA network from trace files.
...
def parse_info(options, trace):
    ...
    hydradetect = ('dot11n-detect', 'cif-collision')
...
def parse_fdr():
    ...
    defaultparam = {'xlabel': "SINR (dB)", \
                    'ylabel': "FDR", \
                    'title': "Frame-Detection Rate vs. SINR", \
                    'label': None, \
                    'source': [], \
                    'format': None}
